...
- **Риск:** Max Drawdown (R и $), Recovery Factor
- **Zella Score** — 0–100 из 6 факторов (эвристика)
...
- **Скриншоты в БД.** Графики хранятся inline в Postgres (не зависит от внешнего файлового хранилища).
